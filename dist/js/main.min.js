...
var LoadingFunctions = function (_Variables) {
...
var VideoLoader = function (_LoadingFunctions) {
	_inherits(VideoLoader, _LoadingFunctions);

	function VideoLoader() {
		_classCallCheck(this, VideoLoader);

		var _this2 = _possibleConstructorReturn(this, (VideoLoader.__proto__ || Object.getPrototypeOf(VideoLoader)).call(this));

		_this2.youtubeVidArr = ['abU5I9Tj6ZU', 'yVKqqdlHPLI', 'AlvdRkRewvA', 'K3N18cqnzHg', 'd_NQcNYMKG8', '8ycTf2TDH_I', 'Swuka5XJRcw', 'wviBk2BYAzw', '5hHonl2hmiU'];
...
function onYouTubeIframeAPIReady() {
	...
	for (Portfolio.video.videoList = 0; Portfolio.video.videoList < iframes.length; Portfolio.video.videoList++) {
		Portfolio.video.players[Portfolio.video.videoList] = Portfolio.createPortfolioPlayers(iframes[Portfolio.video.videoList], Portfolio.video.videoList, iframes.length);
	}Portfolio.loadFullScreenVideoPlayer();
}

//** MOUSE MOVEMENT NAVIGATION **//

var Navigation = function (_VideoLoader) {
	...
	function Navigation() {
		...
		var _this3 = _possibleConstructorReturn(this, (Navigation.__proto__ || Object.getPrototypeOf(Navigation)).call(this));
...
var animationFunctions = function (_Navigation) {
	_inherits(animationFunctions, _Navigation);

	function animationFunctions() {
		_classCallCheck(this, animationFunctions);

		var _this4 = _possibleConstructorReturn(this, (animationFunctions.__proto__ || Object.getPrototypeOf(animationFunctions)).call(this));

		_this4.charLength;
		_this4.charLengthParser;
		return _this4;
	}
